...
add wave -noupdate -label CLK /tb_fullAdder/CLK
add wave -noupdate -label reset /tb_fullAdder/reset
...
add wave -noupdate -radix unsigned /tb_fullAdder/s_iX
add wave -noupdate -radix unsigned /tb_fullAdder/s_iY
add wave -noupdate -radix unsigned /tb_fullAdder/s_iC
...
add wave -noupdate -radix unsigned /tb_fullAdder/s_S
add wave -noupdate -radix unsigned /tb_fullAdder/s_C
...
# add wave -noupdate -divider {Standard Inputs}
# add wave -noupdate /tb_fullAdder/CLK
# add wave -noupdate /tb_fullAdder/reset
...
# add wave -noupdate /tb_fullAdder/DUT0/g_Not/o_F
# add wave -noupdate /tb_fullAdder/DUT0/g_Or/i_A
#add wave -noupdate /tb_fullAdder/DUT0/g_Or/i_B
