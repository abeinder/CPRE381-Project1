...
add wave -noupdate -radix unsigned /tb_AddSub_N/s_iC
add wave -noupdate -radix unsigned /tb_AddSub_N/s_X
add wave -noupdate -radix unsigned /tb_AddSub_N/s_Y

add wave -noupdate -divider {Data Outputs - Decimal}
add wave -noupdate -radix signed /tb_AddSub_N/s_S
add wave -noupdate -radix signed /tb_AddSub_N/s_oC

#add wave -noupdate -radix unsigned /tb_AddSub_N/s_iD1
#add wave -noupdate -radix unsigned /tb_AddSub_N/s_iS
