...
class Updater():
        ...
        def download_tf(self):
                ...
                os.chmod("./internal/quartus/quartus_asm", 0o755)
                os.chmod("./internal/quartus/quartus_fit", 0o755)
                os.chmod("./internal/quartus/quartus_map", 0o755)
                os.chmod("./internal/quartus/quartus_sta", 0o755)
                print("Done.")
                print("Exiting...")
                exit(0)
