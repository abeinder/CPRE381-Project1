...
##              ones complement structural unit.
##              
...
add wave -noupdate -label A /tb_ones_comp/A
...
add wave -noupdate -radix unsigned /tb_ones_comp/O1
add wave -noupdate -radix unsigned /tb_ones_comp/O2
