...
##              2 to 1, Nbit multiplexer unit. It adds some useful signals for testing
...
add wave -noupdate -label A /tb_mux2t1_N/A
add wave -noupdate -label B /tb_mux2t1_N/B
add wave -noupdate -label S /tb_mux2t1_N/S
...
add wave -noupdate -label O /tb_mux2t1_N/O
