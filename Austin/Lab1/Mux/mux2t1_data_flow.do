...
##              2 to 1 multiplexer unit using a behavioral, data flow 
##              description. It adds some useful signals for testing
...
add wave -noupdate -label A /tb_mux2t1_data_flow/A
add wave -noupdate -label B /tb_mux2t1_data_flow/B
add wave -noupdate -label S /tb_mux2t1_data_flow/S
...
add wave -noupdate -radix unsigned /tb_mux2t1_data_flow/O
...
add wave -noupdate /tb_mux2t1_data_flow/DUT0/*
