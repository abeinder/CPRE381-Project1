...
add wave -noupdate -radix unsigned /tb_add_sub/A
add wave -noupdate -radix unsigned /tb_add_sub/B
add wave -noupdate -label Control /tb_add_sub/add_sub_sig
...
add wave -noupdate -radix unsigned /tb_add_sub/O
...
add wave -noupdate /tb_add_sub/DUT0/*
