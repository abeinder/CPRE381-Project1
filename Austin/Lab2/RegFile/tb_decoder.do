...
vsim work.tb_decoder -voptargs=+acc
...
add wave -noupdate -radix unsigned /tb_decoder/A
add wave -noupdate -radix unsigned /tb_decoder/En
add wave -noupdate -label Control /tb_decoder/CLK
...
add wave -noupdate -radix unsigned /tb_decoder/O
...
add wave -noupdate /tb_decoder/DUT0/*
