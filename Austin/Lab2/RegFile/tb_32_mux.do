...
vcom -2008 -work work Lab1/Mux/*.vhd Lab2/*.vhd Lab2/RegFile/*.vhd

vsim work.tb_32_mux -voptargs=+acc
...
add wave -noupdate -radix unsigned /tb_32_mux/*
...
add wave -noupdate -radix unsigned /tb_32_mux/O
...
add wave -noupdate /tb_32_mux/DUT0/*
